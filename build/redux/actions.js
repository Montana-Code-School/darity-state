...
var loginAction = function loginAction(name, token, id, is_npo, profilepic_path) {
  return { type: 'Login', name: name, token: token, id: id, is_npo: is_npo, profilepic_path: profilepic_path };
};
